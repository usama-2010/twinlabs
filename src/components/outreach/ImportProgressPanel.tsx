...
function getRowStatus(
  ...
  if (phase === "finishing" || index < completed) return "done";
...
export function ImportProgressPanel({
  ...
  return (
    <div
      className="outreach-card mt-6 p-6"
      role="status"
      aria-live="polite"
      aria-busy="true"
    >
      ...
      <div className="mt-4 h-2 overflow-hidden rounded-full bg-seafoam-100">
        <div
          className="h-full rounded-full bg-teal-800 transition-[width] duration-300 ease-out"
          style={{ width: `${percent}%` }}
        />
      </div>
